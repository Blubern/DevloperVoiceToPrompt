...
pub struct AppSettings {
    ...
    pub whisper_cli_version: String,
    pub whisper_cli_variant: String,
    ...
    pub ai_selected_enhancer: String,
    pub prompt_enhancer_shortcut: String,
    /// Per-AI-provider configuration, keyed by provider ID.
    pub ai_provider_configs: HashMap<String, serde_json::Value>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            whisper_cli_version: "1.8.3".into(),
            whisper_cli_variant: "cpu".into(),
            whisper_use_gpu: false,
            max_recording_enabled: true,
            max_recording_seconds: 180,
            autostart_enabled: false,
            ai_enabled: false,
            ai_provider: "copilot".into(),
            ai_selected_enhancer: String::new(),
            prompt_enhancer_shortcut: "CommandOrControl+Shift+E".into(),
            ai_provider_configs: HashMap::new(),
...
fn migrate_from_individual_keys(store: &tauri_plugin_store::Store<tauri::Wry>) -> AppSettings {
    ...
    AppSettings {
        ...
        whisper_cli_version: get_str("whisper_cli_version", &defaults.whisper_cli_version),
        whisper_cli_variant: get_str("whisper_cli_variant", &defaults.whisper_cli_variant),
        whisper_use_gpu: get_bool("whisper_use_gpu", defaults.whisper_use_gpu),
        ...
        ai_provider: defaults.ai_provider.clone(),
        ai_selected_enhancer: defaults.ai_selected_enhancer.clone(),
